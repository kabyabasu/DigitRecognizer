package comc.example.kabya.digitrecognizer;
...
import comc.example.kabya.digitrecognizer.models.TensorFlowClassifier;
import comc.example.kabya.digitrecognizer.models.classifer;
import comc.example.kabya.digitrecognizer.models.classification;
import comc.example.kabya.digitrecognizer.views.DrawModel;
import comc.example.kabya.digitrecognizer.views.DrawView;
...
public class MainActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    private List<classifer> mClassifiers = new ArrayList<>();
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btn_clear) {
            ...
            for (classifer classifier : mClassifiers) {
